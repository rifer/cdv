 ...
 * @Gedmo\TranslationEntity(class="AppBundle\Entity\AudioTranslation")
...
class Audio
{
    ...
    public function addTranslation(AudioTranslation $t)
    {
     ...
     * Remove translation
     *
     * @param \AppBundle\Entity\AudioTranslation $translation
     */
    public function removeTranslation(\AppBundle\Entity\AudioTranslation $translation)
    {
